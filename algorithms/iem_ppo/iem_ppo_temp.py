...
"""An implementation of PPO with IEM with TSallis entropy regularization with sparsemax support.
...
class PPO(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.beta = beta
        self.policy_head = policy_head
        print(f"Tsallis q: {self.tsallis_q}, beta: {self.beta}, policy_head: {self.policy_head}")
